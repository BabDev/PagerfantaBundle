- [Introduction](/open-source/packages/pagerfantabundle/docs/5.x/intro)
- [Installation & Setup](/open-source/packages/pagerfantabundle/docs/5.x/installation)
...
- [Reusable Pagerfanta Configurations](/open-source/packages/pagerfantabundle/docs/5.x/reusing-options)
- [Serializer](/open-source/packages/pagerfantabundle/docs/5.x/serializer)
- [Configuring The Bundle](/open-source/packages/pagerfantabundle/docs/5.x/configuring-the-bundle)
